 ...
 */
public class BlockMagicGearbox extends Block implements IHasModel, IMetaName{
    ...
    {
        return Item.getItemFromBlock(BlocksInit.MAGIC_GEARBOX);
    }
    ...
    {
        return new ItemStack(BlocksInit.MAGIC_GEARBOX);
    }
    ...
    public void registerModels() {
        ...
        {
            WuffysMagicMayhem.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "magic_gearbox_" + EnumFacing.values()[i].getName(), "inventory");
        }
    }
