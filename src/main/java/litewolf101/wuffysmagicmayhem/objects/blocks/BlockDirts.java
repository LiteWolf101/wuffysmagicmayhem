 ...
 */
public class BlockDirts extends Block implements IHasModel,IMetaName{
    ...
    public void registerModels() {
        ...
        {
            WuffysMagicMayhem.proxy.registerVariantRenderer(Item.getItemFromBlock(this), i, "dirt_" + EnumWoodHandler.EnumType.values()[i].getName(), "inventory");
        }
    }
    @Override
