...
public class ButtonBiomeDarken extends GuiButton {
    public ButtonBiomeDarken(int buttonID, int x, int y){
        super(buttonID, x, y, 144, 16, "Darkened Woods");
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        if (this.visible)
        {
            ...
            this.drawTexturedModalRect(this.x, this.y, 48, i * 16 - 16, 144, 16);
