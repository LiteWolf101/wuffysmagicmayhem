package litewolf101.wuffysmagicmayhem.utils.client.wmmgui.buttons;
...
public class ButtonBiomeSmoldered extends GuiButton {
    public ButtonBiomeSmoldered(int buttonID, int x, int y){
        super(buttonID, x, y, 144, 16, "Smoldered Lands");
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        if (this.visible)
        {
            ...
            this.drawTexturedModalRect(this.x, this.y, 48, (i * 16 - 16) + 96, 144, 16);
