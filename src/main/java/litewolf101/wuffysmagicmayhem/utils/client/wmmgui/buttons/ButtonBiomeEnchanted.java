...
public class ButtonBiomeEnchanted extends GuiButton {
    public ButtonBiomeEnchanted(int buttonID, int x, int y){
        super(buttonID, x, y, 144, 16, "Enchanted Woods");
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        if (this.visible)
        {
            ...
            this.drawTexturedModalRect(this.x, this.y, 48, (i * 16 - 16) + 32, 144, 16);
