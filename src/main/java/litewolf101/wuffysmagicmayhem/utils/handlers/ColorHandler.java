...
public final class ColorHandler implements IBlockColor{
    ...
    public static void registerExtraBlockColors(){
        Minecraft.getMinecraft().getBlockColors().registerBlockColorHandler(COLOR, BlocksInit.GRASS);
        Minecraft.getMinecraft().getBlockColors().registerBlockColorHandler(COLOR, BlocksInit.STRANGE_GRASS);
    }
    ...
    public static void init(){
        ...
        }, BlocksInit.GRASS, BlocksInit.STRANGE_GRASS, BlocksInit.SHIMMERING_GRASS);
        ...
        itemColors.registerItemColorHandler((stack, tintIndex) -> blockColors.colorMultiplier(((ItemBlock)stack.getItem()).getBlock().getStateFromMeta(stack.getMetadata()), null, null, tintIndex),
                BlocksInit.SHIMMERING_GRASS,
                BlocksInit.GRASS,
                BlocksInit.STRANGE_GRASS
                );
    }
